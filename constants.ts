  ...
  en: [
    {
      id: "1",
      text: "📊 Account Types",
      query: "Give me a brief comparison of ComoFX account types (Micro, Standard, ECN) in a table format showing minimum deposit, spreads, lot size, and best use case. Include a link to the account types page."
    },
    {
      id: "2",
      text: "💹 Spreads & Fees",
      query: "What are ComoFX spreads and commission fees? Keep it short with key numbers and link to trading conditions page."
    },
    {
      id: "3",
      text: "🧮 Lot Size & Leverage",
      query: "Explain ComoFX minimum lot size and maximum leverage briefly. What does nano lot mean?"
    },
    {
      id: "4",
      text: "💻 MT5 Setup",
    ...
    },
    {
      ...
      query: "What are the deposit and withdrawal methods, minimums, and processing times at ComoFX? Include a link to funding page."
    },
    {
      id: "6",
      text: "🛡️ Regulation",
      query: "Is ComoFX regulated? What is your license number? Keep it brief."
    },
    {
      id: "7",
      text: "🤝 IB Partnership",
      query: "How do I become a ComoFX IB partner? List the steps briefly and explain commission options. Include links to IB program and commission plans pages."
    }
  ]
};
...
export const ACCOUNT_TYPES = {
  ...
  pro: {
    label: "Pro",
    min_deposit_usd: 500,
    spreads: "Ultra-low spreads",
    bonus: "Up to 100%",
    commission: "Low commission",
    instruments: "100+",
    lot_size: "Micro lots",
    max_leverage: "1:500",
    note: "Pro is the ‘ultra-low’ tier on Account Types page; some pages also refer to an ‘ECN Account’ model."
  },
  ecn_model_reference: {
    label: "ECN (Pricing Model Reference)",
    spreads_from_pips: 0.1,
    commission: "No commission (as stated on Trading Conditions page)",
    note:
      "Use as a pricing model reference; if user asks ECN vs Pro, present both page statements and recommend verifying current portal costs."
  }
} as const;
...
export const TRADING_CONDITIONS = {
  ...
  pricing_notes: [
    "Trading Conditions page says Micro/Standard/ECN all have no commission.",
    "Account Types page says Pro has low commission.",
    "When asked, disclose the discrepancy and point user to the client portal for exact pricing."
  ]
} as const;
...
export const SUPPORT = {
  live_chat: {
    availability: "24/7 (AI Chatbot) / Everyday 9 a.m. - 6 p.m. (UTC+2) (Live Agent)",
    response_time: "< 2 minutes"
  },
  whatsapp: {
    availability: "Everyday 9 a.m. - 6 p.m. (UTC+2)",
...
2. **NO CONTACT INFO:** Never show WhatsApp, Email, or Phone (+27318802822).
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
3) ACCOUNT TYPES (Micro / Standard / Pro) + ECN PRICING MODEL REFERENCE
A) Account Types page (canonical for “min deposit” by account):
- Micro: min deposit $10, balanced spreads, bonus up to 100%, no commission, 100+ instruments, nano lots, max leverage 1:500
- Standard: min deposit $100, low spreads, bonus up to 100%, no commission, 100+ instruments, micro lots, max leverage 1:500
- Pro: min deposit $500, ultra-low spreads, bonus up to 100%, *low commission*, 100+ instruments, micro lots, max leverage 1:500

B) Trading Conditions page (canonical for “spreads-from pricing model”):
- Micro: spreads from 1.0 pips, no commission
- Standard: spreads from 1.0 pips, no commission
- ECN: spreads from 0.1 pips, no commission

C) How to answer “ECN vs Pro?”
- Explain: “ECN” appears as a pricing model on Trading Conditions; “Pro” appears as the ultra-low tier on Account Types.
- Provide both statements and add: “Exact total costs can vary by instrument and what your portal displays.”
...
Then personalize:
- **Popup Context:** Give shorter, direct responses.
...
End with: "Would you like the answer in Turkish or English?" ONLY if user’s language is ambiguous.
`;
...
export const QUICK_ANSWERS = {
  en: {
    min_deposit:
      "Funding page shows minimum deposit **$25**; Account Types shows Micro minimum **$10**. Minimums may differ by method/portal flow.",
    spreads:
      "Trading Conditions page: Micro & Standard from **1.0 pips**, ECN from **0.1 pips**, all listed as “no commission”. Account Types page: Pro is marked as “low commission”.",
    support:
      "Live Chat: **AI 24/7** + live agents **daily 9am–6pm (UTC+2)**; WhatsApp same hours; email response **<4 hours**."
  }
} as const;
