    ...
    en: [
        {
            ...
            text: "📊 Account Types",
            query:
                "Give me a brief comparison of CM Globals account types (Low-Spread, Islamic, Pro) in a table format showing leverage, spreads, swaps, and best use case. Include a link to open an account."
        },
        {
            id: "2",
            text: "💹 Spreads & Fees",
            query:
                "What are CM Globals spreads and commission fees? Keep it short with key numbers."
        },
        {
            id: "3",
            text: "🧮 Lot Size & Leverage",
            query:
                "Explain CM Globals minimum lot size and maximum leverage briefly. What leverage options are available?"
        },
        {
            id: "4",
            text: "💻 MT5 Setup",
        ...
        },
        {
            ...
            query:
                "What are the deposit and withdrawal methods at CM Globals? List the payment options."
        },
        {
            id: "6",
            text: "🛡️ Regulation",
            query:
                "Is CM Globals regulated? What are your license numbers? Keep it brief."
        },
        {
            id: "7",
            text: "🤝 IB Partnership",
            query:
                "How do I become a CM Globals IB partner? List the steps briefly and explain the partnership programs."
        }
    ]
};
...
export const PLATFORMS = {
    ...
    downloads: {
        ...
        android:
            "https://download.mql5.com/cdn/mobile/mt5/android?server=CMGlobals-Demo"
    },
    notes: [
...
- General Company & Platform (What is CM Globals, services, licensing, safety)
- Account Types & Registration (How to open account, documents, account types)
- Deposits & Withdrawals (Methods, processing times)
- Trading Conditions (Leverage, commissions, swaps)
- Tradable Instruments (Forex pairs, metals, crypto, indices)
- Platform & Technology (MT5, mobile app, EA, hedging)
- Security & Data Protection (SSL, segregated funds, privacy)
- Education & Support (Knowledge Hub, support hours)
- Partnership Programs (Affiliate, IB, Master IB)
